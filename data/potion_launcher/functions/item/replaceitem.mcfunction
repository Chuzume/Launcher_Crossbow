...
# 置き換え
    ...
    execute store result storage chuz:context Item.Mainhand.tag.ChuzData.CoolTime int 1 run data get storage chuz:context Item.tag.ChuzData.CoolTime 0.99999
