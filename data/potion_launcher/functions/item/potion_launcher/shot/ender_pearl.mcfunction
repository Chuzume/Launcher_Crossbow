...
# 目線の高さに召喚
    execute anchored eyes run summon ender_pearl ^ ^ ^ {Fire:2,Tags:["Pot.L_ProjectileInit"]}
...
# Init処理
    execute as @e[type=ender_pearl,tag=Pot.L_ProjectileInit] at @s rotated as @p[tag=Chuz_This] run function potion_launcher:entity/projectile_common/init
