...
# スニークでチャージ
    execute if data storage chuz:context Item.Mainhand.tag.ChuzData.LoadedItem run scoreboard players add @s[predicate=potion_launcher:sneak] Pot.L_Charge 1 
...
# 矢
    execute if entity @s[scores={Pot.L_Shot=0..}] if data storage chuz:context Item.Mainhand.tag.ChuzData.LoadedItem{id:"minecraft:arrow"} run function potion_launcher:item/potion_launcher/consume

# 光の矢
    execute if entity @s[scores={Pot.L_Shot=0..}] if data storage chuz:context Item.Mainhand.tag.ChuzData.LoadedItem{id:"minecraft:tipped_arrow"} run function potion_launcher:item/potion_launcher/consume

# ポーション矢
    execute if entity @s[scores={Pot.L_Shot=0..}] if data storage chuz:context Item.Mainhand.tag.ChuzData.LoadedItem{id:"minecraft:spectral_arrow"} run function potion_launcher:item/potion_launcher/consume

# 花火
    execute if entity @s[scores={Pot.L_Shot=0..}] if data storage chuz:context Item.Mainhand.tag.ChuzData.LoadedItem{id:"minecraft:firework_rocket"} run function potion_launcher:item/potion_launcher/consume
